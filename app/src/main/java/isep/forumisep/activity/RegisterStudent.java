...
import isep.forumisep.*;

import isep.forumisep.app.AppConfig;
import isep.forumisep.app.AppController;
import isep.forumisep.helper.SQLiteHandler;
...
public class RegisterStudent extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        inputEmail = (EditText) findViewById(R.id.register_mail);
            ...
            public void onClick(View view) {
                ...
                if (!email.isEmpty() && !password.isEmpty()) {
                    ...
                    Toast.makeText(getApplicationContext(),
                            "Register by filling the form!", Toast.LENGTH_SHORT)
                            .show();
                }
            }
        });
        // Link to Login Screen   ok
    ...
    private void registerUser(final String email,
        ...
        pDialog.setMessage("Registering ...");//ok
        showDialog();//ok

        // Request a string response post to the provided URL.
        StringRequest strReq = new StringRequest(Method.POST,
            ...
            public void onResponse(String response) {
                ...
                hideDialog();
                try {
                    //Creates a new JSONObject with name/value mappings from the JSON string--response.
